...
# All modules
from modules.factordb_fast import factordb_search
...
from modules.factoring.ecm import ecm1
...
def main():
    ...
    if(factordb_search(args.number,args) == None):
        ...
        for k in range(len(All_Alg)):
            ...
            ## Create Thread
            t1 = threading.Thread(target = All_Alg[k][1], args = (stopper,args.number,args))
